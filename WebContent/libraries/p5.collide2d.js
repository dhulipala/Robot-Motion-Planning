...
p5.prototype.collideLineLine = function(x1, y1, x2, y2, x3, y3, x4, y4,
		calcIntersection) {
	...
	if ((x1 == x3 && y1 == y3) || (x1 == x4 && y1 == y4)
		...
		// Lines are touching on one point
		return false;
	}
...
p5.prototype.collideLineRect = function(x1, y1, x2, y2, rx, ry, rw, rh,
		calcIntersection) {
...
p5.prototype.collideCirclePoly = function(cx, cy, diameter, vertices, interior) {
	...
	for (var current = 0; current < vertices.length; current++) {
		...
		var collision = collideLineCircle(vc.x, vc.y, vn.x, vn.y, cx, cy,
				diameter);
		if (collision)
			return true;
	}
